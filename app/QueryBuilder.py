...
def table_info(tableName, proper, proper_type):
    ...
    for i in range(len(proper)):
        txt += "<span class='text-attribute'>" + str(proper[i]) + "(" + type_to_string(
            proper_type[i]) + ")</span>" + " "
...
class OurQuery:
    ...
    def select_query(self):
        ...
        if query_num == 0:  # 필요한 요소만 출력
            ...
            result.add(str(q))
            txt1.append(table_info(tableName, proper, proper_type))
            txt1.append(str(tableName) + " 테이블에서 " + "<span class='text-attribute'>" + str(
                input_proper) + " column</span>에서 데이터를 조회하는 SQL문을 작성해 주세요. SQL을 실행하면 다음과 같이 출력되어야 합니다.")
            if OnAndOff == True:
                txt1.append(AboutOurQuery(str(q)).Similar())
            elif OnAndOff == False:
                txt1.append("하")
        ...
        if query_num == 0:  # 중복없이 출력하기
            ...
            result.add(str(q))
            txt1.append(table_info(tableName, proper, proper_type))
            txt1.append(str(tableName) + " 테이블에서 " + str(
                input_tem) + " column에서 데이터를 <span class='text-attribute'>중복값 없이 조회하는</span> SQL문을 작성해 주세요. SQL을 실행하면 다음과 같이 출력되어야 합니다.")
            if OnAndOff == True:
                txt1.append(AboutOurQuery(str(q)).Similar())
            elif OnAndOff == False:
                txt1.append("하")
        ...
        while len(result) != query_count:
            ...
            if type(col_type) is int or type(col_type) is float:
                ...
                if r_num == 0:  # num 이상인 테이블 출력
                    ...
                    result.add(q)
                    txt1.append(table_info(tableName, proper, proper_type))
                    txt1.append(str(tableName) + " 테이블에서 " + random_proper[
                        0] + " column에서 " + "<span class='text-attribute'>" + str(
                        num) + " 이상인 값들을 조회하는</span> SQL문을 작성해 주세요. SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                        txt1.append("하")
                    ...
                    txt1.append(str(tableName) + " 테이블에서 " + random_proper[
                        0] + " column에서 " + "<span class='text-attribute'>" + str(
                        num) + " 이하인 값들을 조회하는</span> SQL문을 작성해 주세요. SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                        txt1.append("하")
                    ...
                    txt1.append(str(tableName) + " 테이블에서 " + random_proper[
                        0] + " column에서 " + "<span class='text-attribute'>" + str(
                        num) + " 과 같은 값들을 조회하는</span> SQL문을 작성해 주세요. SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                        txt1.append("하")
                    ...
                    txt1.append(table_info(tableName, proper, proper_type))
                    txt1.append(str(tableName) + " 테이블에서 " + random_proper[
                        0] + " column에서 " + " <span class='text-attribute'>최대값을 조회하는</span> SQL문을 작성해 주세요. SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                        txt1.append("하")
                    ...
                    txt1.append(table_info(tableName, proper, proper_type))
                    txt1.append(str(tableName) + " 테이블에서 " + random_proper[
                        0] + " column에서 " + "<span class='text-attribute'>최솟값을 조회하는</span> SQL문을 작성해 주세요. SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                        txt1.append("하")
                    ...
                    txt1.append(table_info(tableName, proper, proper_type))
                    txt1.append(str(tableName) + " 테이블에서 " + random_proper[
                        0] + " column에서 " + " <span class='text-attribute'>최대값과 최솟값의 차이를 나타내는</span> SQL문을 작성해 주세요. SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                        txt1.append("하")
                    ...
                    txt1.append(table_info(tableName, proper, proper_type))
                    txt1.append(str(tableName) + " 테이블에서 " + random_proper[
                        0] + " column에서 " + "<span class='text-attribute'>" + str(tmp2) + "과" + str(
                        tmp1) + " 사이값들을 조회하는</span> SQL문을 작성해 주세요. SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                        txt1.append("하")
                    ...
                    txt1.append(str(tableName) + " 테이블에서 " + random_proper[
                        0] + " column에서 " + "<span class='text-attribute'>" + str(tmp2) + "과" + str(
                        tmp1) + " 사이에 있지 않는 값들을 조회하는</span> SQL문을 작성해 주세요. SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                        txt1.append("하")
                    ...
                    txt1.append(table_info(tableName, proper, proper_type))
                    txt1.append(str(tableName) + " 테이블에서 " + random_proper[
                        0] + " column에서 " + "데이터들을 <span class='text-attribute'>내림차순으로 조회하는</span> SQL문을 작성해 주세요. SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                        txt1.append("하")
                    ...
                    result.add(q)
                    txt1.append(table_info(tableName, proper, proper_type))
                    txt1.append(str(tableName) + " 테이블에서 " + "<span class='text-attribute'>" + random_proper[
                        0] + "</span>" + " column에서 " + "데이터들을 <span class='text-attribute'>오름차순으로 조회하는</span> SQL문을 작성해 주세요. SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                        txt1.append("하")
                    ...
                    txt1.append(table_info(tableName, proper, proper_type))
                    txt1.append(str(tableName) + " 테이블에서 " + "<span class='text-attribute'>" + random_proper[
                        0] + "</span>" + " column에서 " + "<span class='text-attribute'>작은수부터 순위를 매기고</span> " + "<span class='text-attribute'>" + str(
                        order_type) + "</span>" + "는 <span class='text-attribute'>사전순으로(오름차순)</span> " + "조회하는 SQL문을 작성해 주세요. " + "SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                        txt1.append("하")
                    ...
                    txt1.append(table_info(tableName, proper, proper_type))
                    txt1.append(str(tableName) + " 테이블에서 " + "<span class='text-attribute'>" + random_proper[
                        0] + "</span>" + " column에서 " + "<span class='text-attribute'>큰수부터 순위를 매기고</span> " + "<span class='text-attribute'>" + str(
                        order_type) + "</span>" + "는 <span class='text-attribute'>사전순으로(오름차순)</span> " + "조회하는 SQL문을 작성해 주세요. " + "SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                    ...
                    txt1.append(str(tableName) + " 테이블에서 " + "<span class='text-attribute'>" + random_proper[
                        0] + "</span>" + " column에서 " + "<span class='text-attribute'>작은수부터 순위를 매기고</span> " + "<span class='text-attribute'>" + str(
                        order_type) + "</span>" + "는 <span class='text-attribute'>사전역순으로(내림차순)</span> " + "조회하는 SQL문을 작성해 주세요. " + "SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                        txt1.append("하")
                    ...
                    q = Query.from_(tableName).select('*')
                    q = str(q)
                    q += " where " + random_proper[0] + " >= (SELECT avg(" + random_proper[
                        0] + ") FROM " + tableName + ") " + "ORDER BY " + random_proper[0]
                    q = q.replace("\"", "")
                    result.add(q)
                    txt1.append(table_info(tableName, proper, proper_type))
                    txt1.append(str(tableName) + " 테이블에서 " + "<span class='text-attribute'>" + random_proper[
                        0] + "</span>" + " column에서 " + "해당 column의 <span class='text-attribute'>평균보다 " + "크거나 같은</span> 데이터를 <span class='text-attribute'>오름차순으로 조회하는</span> SQL문을 작성해 주세요. " + "SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                        txt1.append("하")
                    ...
                    q = str(q)
                    q += " where " + random_proper[0] + " >= (SELECT avg(" + random_proper[
                        0] + ") FROM " + tableName + ") " + "ORDER BY " + random_proper[0] + " DESC"
                    q = q.replace("\"", "")
                    result.add(q)
                    txt1.append(table_info(tableName, proper, proper_type))
                    txt1.append(str(tableName) + " 테이블에서 " + "<span class='text-attribute'>" + random_proper[
                        0] + "</span>" + " column에서 " + "해당 column의 <span class='text-attribute'>평균보다 " + "크거나 같은</span> 데이터를 <span class='text-attribute'>내림차순으로 조회하는</span> SQL문을 작성해 주세요. " + "SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                        txt1.append("하")
                    ...
                    txt1.append(table_info(tableName, proper, proper_type))
                    txt1.append(str(tableName) + " 테이블에서 " + "<span class='text-attribute'>" + random_proper[
                        0] + "</span>" + " column에서 " + "해당 column의 <span class='text-attribute'>평균보다 " + "크거나 같은 테이블의 갯수를 조회하는</span> SQL문을 작성해 주세요. " + "SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                        txt1.append("하")
                ...
                if r_num == 0:  # 내림차순 정렬
                    ...
                    txt1.append(table_info(tableName, proper, proper_type))
                    txt1.append(str(tableName) + " 테이블에서 " + random_proper[
                        0] + " column에서 " + "<span class='text-attribute'>내림차순으로 조회하는</span> SQL문을 작성해 주세요. " + "SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                        txt1.append("하")
                    ...
                    txt1.append(table_info(tableName, proper, proper_type))
                    txt1.append(str(tableName) + " 테이블에서 " + random_proper[
                        0] + " column에서 " + "<span class='text-attribute'>오름차순으로 조회하는</span> SQL문을 작성해 주세요. " + "SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                        txt1.append("하")
                    ...
                    txt1.append(table_info(tableName, proper, proper_type))
                    txt1.append(str(tableName) + " 테이블에서 " + random_proper[
                        0] + " column에서 " + "<span class='text-attribute'>" + "'" + meta_data[
                                    0] + "'" + "인 문자로 시작하는 데이터를 조회하는</span> SQL문을 작성해 주세요. " + "SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                        txt1.append("하")
                    ...
                    txt1.append(str(tableName) + " 테이블에서 " + random_proper[
                        0] + " column에서 " + "<span class='text-attribute'>" + "'" + meta_data[
                                    0] + "'" + "인 문자를 포함하는 데이터를 조회하는</span> SQL문을 작성해 주세요. " + "SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                        txt1.append("하")
                    ...
                    txt1.append(str(tableName) + " 테이블에서 " + random_proper[
                        0] + " column에서 " + "<span class='text-attribute'>" + "'" + meta_data[
                                    len(meta_data) - 1] + "'" + "인 문자로 끝나는 데이터를 조회하는</span> SQL문을 작성해 주세요. " + "SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                    if OnAndOff == True:
                        txt1.append(AboutOurQuery(str(q)).Similar())
                    elif OnAndOff == False:
                        txt1.append("하")
    ...
    def insert_query(self):
        ...
        result.append(query)
        txt1.append(table_info(tableName, proper, proper_type))
        txt1.append(str(tableName) + "테이블에서 " + insert_col(
            proper) + "column에 순차적으로 " + query_proper + "의 데이터를 삽입하는 SQL문을 작성해 주세요." + " SQL을 실행하면 다음과 같이 출력되어야 합니다.")
        if OnAndOff == True:
    ...
    def delete_query(self):
        ...
        while len(result) != tablecount:
            ...
            query = "DELETE FROM " + str(tableName) + " WHERE " + str(random_proper[proper_num]) + " = \'" + str(
                update_query[random_proper[proper_num]]) + "\'"
            # print(random_proper[proper_num], " 속성이 " , update_query[random_proper[proper_num]] , " 에 해당하는 값의 테이블을 삭제")
            result.append(query)
            txt1.append(table_info(tableName, proper, proper_type))
            txt1.append(str(tableName) + "테이블에서 " + "<span class='text-attribute'>" + str(random_proper[
                                                                                              proper_num]) + "에 해당하는 데이터를 삭제하는</span>" + " SQL문을 작성해주세요." + " SQL을 실행하면 다음과 같이 출력되어야 합니다.")
            if OnAndOff == True:
                txt1.append(AboutOurQuery(str(query)).Similar())
            elif OnAndOff == False:
                txt1.append("하")
    ...
    def update_query(self):
        ...
        while query_count != len(result):
            ...
            if type(pull_table_data(target_table, mainkey[sel_key])) is int or type(
                    pull_table_data(target_table, mainkey[sel_key])) is float:
                query = "UPDATE " + str(tableName) + " SET " + str(tmp_set) + " WHERE " + mainkey[
                    sel_key] + " = " + str(pull_table_data(target_table, mainkey[sel_key]))
            else:
                query = "UPDATE " + str(tableName) + " SET " + str(tmp_set) + " WHERE " + mainkey[
                    sel_key] + " = " + "\"" + str(pull_table_data(target_table, mainkey[sel_key])) + "\""
            k = query.split('WHERE')
            ...
            txt1.append(str(tableName) + "테이블에서 " + str(mainkey[sel_key]) + "필드의 값이 " + bb + "인 모든 레코드의 " + update_info(
                a) + "로 변경하는 SQL문을 작성해주세요." + " SQL을 실행하면 다음과 같이 출력되어야 합니다.")
            if OnAndOff == True:
                txt1.append(AboutOurQuery(str(query)).Similar())
            elif OnAndOff == False:
                txt1.append("하")
    ...
    def join_query(self, right_table, right_table_name):
        ...
        if query_count == 1:
            ...
            if r_num == 0:
                ...
                txt2 += table_info(tablename, lproper, lproper_type) + table_info(right_table_name, rproper,
                                                                                  rproper_type)
                txt1.append(txt2)
                txt1.append(str(tablename) + "테이블과 " + str(
                    right_table_name) + "테이블에는 id 속성이 공통으로 있습니다. " + "이 속성을 기준으로 하여 " + insert_col(
                    lproper) + insert_col(rproper) + "데이터들을 조회하는 SQL문을 작성해주세요." + " SQL을 실행하면 다음과 같이 출력되어야 합니다.")
                if OnAndOff == True:
                    txt1.append(AboutOurQuery(str(query)).Similar())
                elif OnAndOff == False:
                    txt1.append("하")
                ...
                txt1.append(str(tablename) + "테이블과 " + str(
                    right_table_name) + "테이블에는 id 속성이 공통으로 있습니다. " + "이 속성을 기준으로 하여 " + insert_col(
                    lproper) + insert_col(
                    rproper) + "데이터들을 조회하는 SQL문을 작성해주세요." + " 단, id 값이 존재하지 않다면 NULL값으로 대신합니다." + " SQL을 실행하면 다음과 같이 출력되어야 합니다.")
            ...
            txt1.append(txt2)
            txt1.append(str(tablename) + "테이블과 " + str(
                right_table_name) + "테이블에는 id 속성이 공통으로 있습니다. " + "이 속성을 기준으로 하여 " + insert_col(lproper) + insert_col(
                rproper) + "데이터들을 조회하는 SQL문을 작성해주세요." + " SQL을 실행하면 다음과 같이 출력되어야 합니다.")
            if OnAndOff == True:
                txt1.append(AboutOurQuery(str(query)).Similar())
            elif OnAndOff == False:
                txt1.append("하")
